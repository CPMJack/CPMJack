...
⠀⠀.                   
   _____           _____           _                               
  / ____|         |  __ \         | |       /\                     
 | |     __ _ _ __| |__) |_ _ _ __| | __   /  \  _   _  __ _ _ __  
 | |    / _` | '__|  ___/ _` | '__| |/ /  / /\ \| | | |/ _` | '_ \ 
 | |___| (_| | |  | |  | (_| | |  |   <  / ____ \ |_| | (_| | | | |
  \_____\__,_|_|  |_|   \__,_|_|  |_|\_\/_/    \_\__, |\__,_|_| |_|
                                                  __/ |            
                                                 |___/             
...
from cpmjack import CPMJack

__CHANNEL_USERNAME__ = "CPMJackChannel"
__GROUP_USERNAME__   = "CPMJackCommunity"
...
def banner(console):
    ...
    brand_name = figlet_format('CPMJack', font='bloody')
    colors = [
...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            print(Colorate.Horizontal(Colors.rainbow, '===============[ 𝐀𝐲𝐚𝐧 ]==============='))
